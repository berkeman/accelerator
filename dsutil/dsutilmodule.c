...
MKITER(ReadInt64    , int64_t  , pyInt_FromS64         , hash_integer  , int64_t  , 1)
MKITER(ReadInt32    , int32_t  , pyInt_FromS32         , hash_integer  , int64_t  , 1)
MKITER(ReadBits64   , uint64_t , pyInt_FromU64         , hash_integer  , uint64_t , 0)
...
MKWRITER(WriteInt64      , int64_t  , int64_t  , pyLong_AsS64          , 1,                                   , minmax_set_Int64  , hash_integer  );
MKWRITER(WriteInt32      , int32_t  , int64_t  , pyLong_AsS32          , 1,                                   , minmax_set_Int32  , hash_integer  );
MKWRITER(WriteBits64     , uint64_t , uint64_t , pyLong_AsU64          , 0,                                   , minmax_set_Bits64 , hash_integer  );
MKWRITER(WriteBits32     , uint32_t , uint64_t , pyLong_AsU32          , 0,                                   , minmax_set_Bits32 , hash_integer  );
